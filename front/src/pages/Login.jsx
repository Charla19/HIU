    ...
    return (
      <div className="bg-white min-h-screen flex flex-col items-center justify-center gap-[24px] max-w-[840px] mx-auto">
        ...
        <span className="block mt-4">
          Veuillez vérifier la photo que vous avez entré.
        </span>
        <Link
          to="/user-select"
          className="mt-4 inline-flex items-center rounded-md bg-sky-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-600"
        >
          <svg
            strokeWidth={1.5}
            className="ml-1.5 h-5 w-5 mr-2"
            viewBox="0 0 24 24"
            fill="none"
